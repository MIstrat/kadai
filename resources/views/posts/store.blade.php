            ...
            <form action="/index" method="POST">
                @csrf
                    ...
                    <div class="post-site_name flex justify-start">
                        ...
                        <div><input type="text" name="sites[site_name]" ></div>
                        <div><p class="site_name-error" style="color:red">{{ $errors->first('sites.site_name') }}</p></div>
                    </div>
                    <br>
                    <div class="post-site_url flex justify-start">
                        <div class="w-1/6"><h2>サイトURL：</h2></div>
                        <div><input type="text" name="sites[site_url]"  ></div>
                        <div><p class="site_url-error" style="color:red">{{ $errors->first('sites.site_url') }}</p></div>
                    </div>
                    <br>
